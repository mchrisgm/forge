...
export const IconBrain = (p: IconProps) => (
  <Icon {...p}>
    <path d="M12 4.8A2.6 2.6 0 0 0 9.6 3.2 2.6 2.6 0 0 0 7 5.8a3.1 3.1 0 0 0-2.4 3.7A3.1 3.1 0 0 0 4 14.6a3.1 3.1 0 0 0 2.7 3.9 2.7 2.7 0 0 0 5.3-.7V4.8Z" />
    <path d="M12 4.8a2.6 2.6 0 0 1 2.4-1.6A2.6 2.6 0 0 1 17 5.8a3.1 3.1 0 0 1 2.4 3.7 3.1 3.1 0 0 1 .6 5.1 3.1 3.1 0 0 1-2.7 3.9 2.7 2.7 0 0 1-5.3-.7" />
    <path d="M9 8.5c-.8.2-1.4.7-1.7 1.4M15 8.5c.8.2 1.4.7 1.7 1.4" />
  </Icon>
);
