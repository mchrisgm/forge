...
version: "0.4.14"
license: BSD-3-Clause — complete terms in LICENSE
metadata:
  # Provenance: vendored (trimmed) into Forge from the upstream repository.
  origin: "D4Vinci/Scrapling v0.4.14 (agent-skill/Scrapling-Skill)"
  origin_url: "https://github.com/D4Vinci/Scrapling"
...
This is a trimmed vendored copy — only the references below are bundled; the full set (dynamic/stealthy fetching, spiders, Scrapy integration, BeautifulSoup migration) lives in the upstream repository at `https://github.com/D4Vinci/Scrapling/tree/main/agent-skill`.
...
- `references/fetching/choosing.md` - How to choose between the fetchers/sessions for a target website
- `references/parsing/selection.md` - Selecting elements (CSS, XPath, text, similarity) from fetched pages
- `https://github.com/D4Vinci/Scrapling/tree/main/docs` - Full official docs in Markdown for quick access (use if the bundled references do not cover the topic or look out-of-date).
